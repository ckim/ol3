...
ol.control.OverviewMap.prototype.setMap = function(map) {
  ...
  if (!goog.isNull(map)) {
    ...
    goog.events.listen(
        view, ol.Object.getChangeEventType(ol.ViewProperty.CENTER),
        this.handleCenterChanged_, false, this);

    goog.events.listen(
        view, ol.Object.getChangeEventType(ol.ViewProperty.RESOLUTION),
        this.handleResolutionChanged_, false, this);

    goog.events.listen(
        view, ol.Object.getChangeEventType(ol.ViewProperty.ROTATION),
...
ol.control.OverviewMap.prototype.maximize_ = function() {
  ...
  goog.dom.classlist.remove(this.element, this.elementMinimizedClass_);
...
ol.control.OverviewMap.prototype.minimize_ = function() {
  ...
  goog.dom.classlist.add(this.element, this.elementMinimizedClass_);
